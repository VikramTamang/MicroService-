...
public class StockReleaseRequest {
    ...
    @NotEmpty(message = "Items list to release cannot be empty")
    @Valid
    ...
    public static class Builder {
        private final StockReleaseRequest request = new StockReleaseRequest();
        public Builder orderTrackingNumber(String orderTrackingNumber) { request.setOrderTrackingNumber(orderTrackingNumber); return this; }
        public Builder items(List<StockReservationItem> items) { request.setItems(items); return this; }
        public StockReleaseRequest build() { return request; }
    }
}
